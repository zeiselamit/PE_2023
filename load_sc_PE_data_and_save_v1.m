...
sam_cell = {'134_3','134_2','61_1','63_1','63_2','67_1','67_2','68_1','68_2','77_1','78_1',...
    '86_1','87_1','88_1','92_1','99_1','101_1','103_1','104_1','105_1','106_1','107_1','107_2','108_1',...
    '113_2','114_2','116_1','117_1','119_1','120_1','120_2'};
sam_folder = {'out10X48_1_200706','out10X53_1_200706'....
    ,'out10X61_1_201203','out10X63_1_201203','out10X63_2_201203','out10X67_1_201203','out10X67_2_201203'...
    ,'out10X68_1_201203','out10X68_2_201203','out10X77_1_210104','out10X78_1_210104','out10X86_1_210221',...
    'out10X87_1_210221','out10X88_1_210221','out10X92_1_210224','out10X99_1_210415','out10X101_1_210415',....
    'out10X103_1_210626','out10X104_1_210626','out10X105_1_211004','out10X106_1_211004','out10X107_1_210626',...
    'out10X107_2_211004','out10X108_1_210626','out10X113_2_211004','out10X114_2_210823','out10X116_1_210823',...
    'out10X117_1_210823','out10X119_1_211004','out10X120_1_211004','out10X120_2_211004'};
...
eval(['cellid = [',str,'];'])
geneid = geneid_120_1(:,1);

[num,txt,raw] = xlsread('PE_metadata_220130.xlsx');
num(isnan(num)) = 0;
...
sample_uni = {'48-1','53-1','61-1','63-1','63-2','67-1','67-2','68-1','68-2','77-1','78-1'...
    ,'86-1','87-1','88-1','92-1','99-1','101-1','103-1','104-1','105-1','106-1','107-1','107-2'...
    ,'108-1','113-2','114-2','116-1','117-1','119-1','120-1','120-2'};%
for i=1:length(sample_uni)
    fprintf(['valid cells in ',sample_uni{i},' = ',num2str(sum((strcmpi(sample,sample_uni{i})))),'\n']);
end


save(['PE_QC800_400_afterloading_',date],'data','cellid','sample','sample_uni','geneid'...
    ,'ctrl_flag','v3_flag'...
