...
cellid_type(~(typenum==5),:) = [];% selecting only immune
...
% validcells(loc) = true;
sample_uni = {'48-1','53-1','61-1','63-1','63-2','67-1','67-2','68-1','68-2','77-1','78-1','86-1','87-1','88-1','92-1','99-1','101-1','103-1','104-1','105-1','106-1','107-1','107-2','108-1','113-2','114-2','116-1','117-1','119-1'};%
...
linkaxes([ax1,ax2],'y')
if savefig_flag==1
    savefig(gcf,['tree_step2_trophoblasts_',date,'.fig'])    
end
...
if savefig_flag==1
    savefig(gcf,['tsne_by_cluster_step2_trophoblasts_perplexity',num2str(perplexity),'_',date,'.fig'])
    eval(['export_fig tsne_by_cluster_step2_trophoblasts','_',date,'.pdf']);
end
...
if savefig_flag==1
    savefig(gcf,['trophoblasts_step2_tsne_by_sample_perplexity',num2str(perplexity),'_',date,'.fig'])
...
if savefig_flag==1
    savefig(gcf,['trophoblats_step2_median_per_condition_',num2str(perplexity),'_',date,'.fig'])
    eval(['export_fig trophoblasts_step2_median_per_condition_','_',date,'.pdf']);
end
%% marker table 
...
if savefig_flag==1
    savefig(gcf,['trophoblats_step2_markertable_',date,'.fig']) 
    eval(['export_fig trophoblats_step2_markertable_','_',date,'.pdf']);
end

% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 

table2 = [cellid_sorted,m2c(T_cells_tmp)];
saveCellFile(table2,['trophoblasts_step2_cellid_cluster_beforeclean_',date,'.txt']);
